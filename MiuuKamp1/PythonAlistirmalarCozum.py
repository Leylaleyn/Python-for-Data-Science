...
####################### LIST COMPREHENSİON UYGULAMA 2 ##############33
""" Görev 1:  List Comprehension yapısı kullanarak car_crashes verisindeki numeric değişkenlerin isimlerini büyük harfe çeviriniz ve
başına NUM ekleyiniz.Numeric olmayan değişkenlerin de isimleri büyümeli.Tek bir list comprehension yapısı kullanılmalı. """
...
print([ "NUM_" + col.upper() for col in  num_cols] )
...
print([ col + "_FLAG" if "no" not in col else col for col in df.columns ])

"""Görev 3 :List Comprehension yapısı kullanarak aşağıda verilen değişken isimlerinden FARKLI olan
değişkenlerin isimlerini seçiniz ve yeni bir data frame oluşturunuz."""
